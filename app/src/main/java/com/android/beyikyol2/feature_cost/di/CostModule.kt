package com.android.beyikyol2.feature_cost.di
...
import com.android.beyikyol2.feature_cost.data.repository.CostRepositoryImpl
...
object CostModule {
    ...
    @Provides
    @Singleton
    fun provideCostUseCase(repository: CostRepository): CostInfo {
        return CostInfo(repository)
    }
    ...
    fun provideCostRepository(
        ...
        return CostRepositoryImpl(api)
    }

    @Provides
    @Singleton
    fun provideCostApi(): CostApi {
        return Retrofit.Builder()
            .baseUrl(OtherApi.BASE_URL)
            .addConverterFactory(GsonConverterFactory.create())
            .build()
            .create(CostApi::class.java)
    }
}